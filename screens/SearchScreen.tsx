                ...
                <Pressable onPress={Keyboard.dismiss} style={tw`flex-1`}>
                    ...
                    >
                        <View style={tw`flex-row items-center bg-transparent`}>
                            <View style={tw`flex-row items-center bg-transparent border rounded-[10px] px-1.5 mt-2 mb-1c border-zinc-300 dark:border-zinc-700`}>
                                <HeaderIcon name="search" customStyle={tw`mr-1 -ml-0.3 text-zinc-400 dark:text-zinc-600`} />
                                <TextInput
                                    value={query}
