...
export default function ChangePasswordScreen() {
  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-[#eee] dark:bg-[#1B1F22]`}>
      <View lightColor="#eee" darkColor="#1B1F22" style={tw`flex-1`}>
        <KeyboardAvoidingView
          style={tw`flex-1`}
          ...
          >
            ...
            >
              {({
                ...
                return (
                  <>
                    <Card style={tw`pt-4 pb-4`}>
                      <View
                        style={tw`flex-row items-center mb-9 bg-transparent mt-3`}
                      >
                        <HeaderIcon
                          name="settings"
                          customStyle={tw`text-[#5A6E54] ml-0 mr-0`}
                        />
                        <Text style={tw`text-[#5A6E54] ml-1 font-light`}>Change Password</Text>
